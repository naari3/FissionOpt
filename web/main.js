$(() => { FissionOpt().then((FissionOpt) => {
  ...
  const fuelPresets = {
    ...
    // NomiTBUO: [84, 22.5],
    NomiLEU235: [600, 50],
    // NomiLEU235O: [168, 62.5],
    NomiHEU235: [2400, 300],
    // NomiHEU235O: [672, 375],
    NomiLEU233: [720, 60],
    // NomiLEU233O: [201.6, 75],
    NomiHEU233: [2880, 360],
    // NomiHEU233O: [806.4, 450],
    NomiLEN236: [450, 36],
    // NomiLEN236O: [126, 45],
    NomiHEN236: [1800, 216],
    // NomiHEN236O: [504, 270],
    // NomiMOX239: [155.4, 57.5],
    // NomiMOX241: [243.6, 97.5],
    NomiLEP239: [525, 40],
    // NomiLEP239O: [147, 50],
    NomiHEP239: [2100, 240],
    // NomiHEP239O: [588, 300],
    NomiLEP241: [825, 70],
    // NomiLEP241O: [231, 87.5],
    NomiHEP241: [3300, 420],
    // NomiHEP241O: [924, 525],
    NomiLEA242: [960, 94],
    // NomiLEA242O: [268.8, 117.5],
    NomiHEA242: [3840, 564],
    // NomiHEA242O: [1075.2, 705],
    NomiLECm243: [1050, 112],
    // NomiLECm243O: [294, 140],
    NomiHECm243: [4200, 672],
    // NomiHECm243O: [1176, 840],
    NomiLECm245: [810, 68],
    // NomiLECm245O: [226.8, 85],
    NomiHECm245: [3240, 408],
    // NomiHECm245O: [907.2, 510],
    NomiLECm247: [690, 54],
    // NomiLECm247O: [193.2, 67.5],
    NomiHECm247: [2760, 324],
    // NomiHECm247O: [772.8, 405],
    NomiLEB248: [675, 52],
    // NomiLEB248O: [189, 65],
    NomiHEB248: [2700, 312],
    // NomiHEB248O: [756, 390],
    NomiLECf249: [1080, 116],
    // NomiLECf249O: [302.4, 145],
    NomiHECf249: [4320, 696],
    // NomiHECf249O: [1209.6, 870],
    NomiLECf251: [1125, 120],
    // NomiLECf251O: [315, 150],
    NomiHECf251: [4500, 720],
    // NomiHECf251O: [1260, 900],
  };
  ...
  run.click(() => {
    ...
    if (opt === null) {
      ...
      try {
        ...
        settings.ensureEdgeOnlyAccessibleCheck = $('#ensureEdgeOnlyAccessibleCheck').is(':checked');
